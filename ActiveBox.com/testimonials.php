    ...
    function consultar(){
      ...
      $.post("includes/_funciones.php", obj, function(respuesta){
        ...
        $.each(respuesta,function(i,e){
          template += `
          <tr>
          <td>${e.testimonial_imagen}</td>
          <td>${e.testimonial_cita}</td>
          <td>${e.testimonial_persona}</td>
          <td>
          <a href="#" data-id="${e.id_testimonial}">Editar</a>
          <a href="#" data-id="${e.id_testimonial}">Eliminar</a>
          </td>
          </tr>
          `;
        });
